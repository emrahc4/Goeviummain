...
const GOOGLE_API_KEY = "AIzaSyCwIyBEX_X_vsW7YBAC62x8pqer0xPcQJg";
    ...
    savedConversations.forEach(conversation => {
        ...
        const userMessageHtml = `
            ...
            <div class="message__content">
                <img class="message__avatar" src="assets/img/profile.png" alt="User avatar">
        ...
        const responseHtml = `
           ...
           <div class="message__content">
                <img class="message__avatar" src="assets/img/gemini.svg" alt="Gemini avatar">
